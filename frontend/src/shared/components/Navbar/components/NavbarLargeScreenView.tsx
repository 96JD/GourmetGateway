...
export default function NavbarLargeScreenView({ open }: Readonly<Props>) {
	...
	return (
		<div id="nav" className="mx-auto max-w-7xl px-2 sm:px-4 lg:px-8">
			<div
				className={classNames("flex h-16", isNavbarSearchFeatureEnabled ? "justify-between" : "justify-start")}
			>
				...
				<div
					className={classNames(
						"hidden lg:ml-6 lg:flex lg:space-x-6",
						!isNavbarSearchFeatureEnabled && "me-auto"
					)}
				>
					<NavbarTabs />
				</div>
